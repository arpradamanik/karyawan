...
<div class="container">
    ...
    <form class="row g-3" method="POST">
        ...
        <div class="col-md-6">
          ...
          <input type="text" class="form-control" name="teacher_name" id="inputEmail4">
        ...
        <div class="col-md-6">
          <label for="inputPassword4" class="form-label">{{session()->get('name')}}</label>
          <input type="text" name="teacher_PHONE" class="form-control" id="inputPassword4">
          <span class="text-danger">
            @error('teacher_PHONE')
            {{$message}}
        ...
        <div class="col-md-6">
          ...
          <input type="text" name="teacher_education" class="form-control" id="inputPassword4">
          <span class="text-danger">
        ...
        <div class="col-md-6">
          ...
          <input type="text" class="form-control" name="teacher_city" id="inputCity">
          <span class="text-danger">
            @error('teacher_city')
            {{$message}}
