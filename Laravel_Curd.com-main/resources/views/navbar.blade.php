...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Laravel_9_Curd</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="{{url('/footer')}}">Home</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{url('/')}}">Insert</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{url('/teacher/view')}}">View</a>
        </li>
